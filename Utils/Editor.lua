...
function Text.Enquote (Info, left, right) --> (bool)
  ...
  left, right = DefineEnquote(left, right)
...
function Text.Dequote (Info, left, right) --> (bool)
  ...
  local l_len, r_len
  left, l_len, right, r_len = DefineDequote(left, right)
...
function Selection.Paste (Info, block, Type) --> (bool)
  ...
  Type = Type or type(block) == 'table' and block.Type
