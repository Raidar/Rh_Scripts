...
local Data = {
  ...
  tSVN_diff         = "&D - Сравнить с предыдущей", -- С&равнить с предыдущей версией
  hSVN_diff         = "Сравнивает файл в рабочей копии с его же версией перед последней фиксацией",
  tSVN_log          = "&L - Журнал",                -- &Журнал
  hSVN_log          = "Показывает журнал для выбранного файла/папки",
  tSVN_browse       = "&R - Обзор хранилища",       -- Обозреватель &хранилища
  hSVN_browse       = "Открывает обозреватель хранилища для оперативной работы с хранилищем",
  tSVN_browseto     = "&R - Обзор хранилища…",      -- ()
  ...
  tSVN_uptorev      = "&8 - Обновить до ревизии…",  -- Обновить &до ревизии…
  ...
  tSVN_revert       = "    Вернуть",                -- Убрать и&зменения
  ...
  tSVN_copy         = "&T - Ветка / тэг…",          -- О&тветвление/метка
  ...
  tSVN_blame        = "&B - Авторство…",            -- &Авторство…
  ...
  tSVN_patching     = "    Применить патч…",        -- Применить за&платку…
  ...
  tSVN_settings     = "&S - Настройки",             -- &Настройки
